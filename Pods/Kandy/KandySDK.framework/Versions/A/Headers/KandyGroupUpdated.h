 ...
 */
-(instancetype)initWithUUID:(NSString*)aUuid timestamp:(NSDate*)aTimestamp groupId:(KandyRecord*)aGroupId groupName:(NSString*)aGroupName groupImage:(id<KandyImageItemProtocol>)aGroupImage updater:(KandyRecord*)anUpdater;
/**
 *  The group ID
 */
