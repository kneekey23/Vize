 ...
 */
-(void) markAsReceived:(NSArray*)kandyEvents responseCallback:(void(^)(NSError* error))responseCallback;
 ...
 */
-(void) pullEventsWithResponseCallback:(void(^)(NSError* error))responseCallback;
